  ...
  return (
    <div className="radar-filter-bar">
      <div className="radar-filter-label-group">
        ...
        <span className="radar-subtitle">Prioritized clause classification</span>
      </div>
      ...
      <div className="radar-tabs" role="tablist" aria-label="Attention Level Filters">
        ...
        >
          ...
          Moderate <span className="tab-count">{counts.moderate}</span>
        </button>
        ...
        >
          <span className="dot dot-standard"></span>
